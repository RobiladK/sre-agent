...
# dispatching rule is PT5M/PT5M, so detection latency swamps a 30-second offset.
...
& $badDeploy -ResourceGroup $ctx.ResourceGroup -ClusterName $ctx.ClusterName -Namespace $Namespace
if ($LASTEXITCODE -ne 0) {
